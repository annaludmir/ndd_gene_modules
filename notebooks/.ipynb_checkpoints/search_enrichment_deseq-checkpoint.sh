...
python -u search_enrichment_deseq.py ['RG_other','IPC_other','differentiting_proliferating','NPCs_other','G1_other','S_other','G2M_other','SG2M_other','Neuron_other','Glioblast_other','Neuroblast_other'] /scratch200/reutj/data/deseq2
