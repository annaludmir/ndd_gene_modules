...
INPUT_FOLDER="results/enrichment_results/"
TOP_N=25

mamba run -p /miridan-data/annaludmir/conda-envs/jupyter-scanpy_new python modules/leading_gene_condition_correlations.py \
  "$INPUT_FOLDER" \
  --top-n "$TOP_N"
