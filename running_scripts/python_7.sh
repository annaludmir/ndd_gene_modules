...
mamba run -p /miridan-data/annaludmir/conda-envs/jupyter-scanpy_new python -u specificity_score_calculations.py /miridan-data/annaludmir/ndd_gene_modules/config_files/ges_score_cortex_config.yaml
