...
mamba run -p /miridan-data/annaludmir/conda-envs/jupyter-scanpy_new python -u enrichment_pipeline_for_gene_list.py /miridan-data/annaludmir/ndd_gene_modules/config_files/enrichment_all_layers_cell_phase_config_v2.yaml
